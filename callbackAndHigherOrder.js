...
var names = ['Tyler', 'Cahlan', 'Ryan', 'Colt','Tylor', 'Blaine', 'Cahlan']
...
// let bigNum = addingFactory(384924875)
// console.log(bigNum(893459846952474))
...
const getUserById = (arr, id, callback) => {
    ...
    console.log('Please input a real id')
    }
  


// console.log(getUserById('16t'))
...
let nmber = 25 // declaring a variabl that equals 25
const arrow = (param, param2) => {   //   setting variable 'arrow' to the value of a function
return param + param2
}
